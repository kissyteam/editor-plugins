...
*/
KISSY.add("editor-plugins/lib/element-path",["editor","node"],function(l,e,m,j){function f(a){this.cfg=a;this._cache=[];this._init()}function c(){}var k=e("editor"),i=e("node");f.prototype={_init:function(){var a=this.cfg.editor;this.holder=i("<span>");this.holder.appendTo(a.get("statusBarEl"),void 0);a.on("selectionChange",this._selectionChange,this);k.Utils.sourceDisable(a,this)},disable:function(){this.holder.css("visibility","hidden")},enable:function(){this.holder.css("visibility","")},_selectionChange:function(a){var g=
