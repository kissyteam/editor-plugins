...
*/
KISSY.add("editor-plugins/lib/flash-common/utils",["swf","dom","node"],function(h,d,i,f){var e=d("swf"),b=d("dom"),g=d("node");f.exports={insertFlash:function(a,c,b,d,e){c=this.createSWF({src:c,attrs:b,document:a.get("document")[0]});b=a.createFakeElement(c.el,d||"ke_flash",e||"flash",!0,c.html,b);a.insertElement(b);return b},isFlashEmbed:function(a){return"application/x-shockwave-flash"===b.attr(a,"type")||/\.swf(?:$|\?)/i.test(b.attr(a,"src")||"")},getUrl:function(a){return e.getSrc(a)},createSWF:function(a){var c=
