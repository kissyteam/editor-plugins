KISSY.add('kg/editor-plugins/1.0.0/lib/dialog-loader',["editor","overlay","dom","ua"],function(S ,require, exports, module) {
/**
 * @ignore
...
module.exports = {
    useDialog: function (editor, name, config, args) {
        ...
        require(['editor-plugins/lib/' + name + '/dialog'], function (Dialog) {
            loadMask.unloading();
