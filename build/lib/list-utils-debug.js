...
*/
KISSY.add('editor-plugins/lib/list-utils', [
    'node',
    'dom',
    'ua'
    ...
    var listNodeNames = {
         ...
         */
            ...
            arrayToList: function (listArray, database, baseIndex, paragraphMode) {
                ...
                var doc = listArray[baseIndex].parent[0].ownerDocument, retval = doc.createDocumentFragment(), rootNode = null, i, currentIndex = baseIndex, indentLevel = Math.max(listArray[baseIndex].indent, 0), currentListItem = null;    //,paragraphName = paragraphMode;
                //,paragraphName = paragraphMode;
                while (true) {
                    var item = listArray[currentIndex];
                    if (item.indent === indentLevel) {
                        if (!rootNode || //用于替换标签,ul->ol ,ol->ul
