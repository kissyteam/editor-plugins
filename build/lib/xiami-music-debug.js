KISSY.add('kg/editor-plugins/lib/1.0.0/xiami-music',["editor","./flash-common/base-class","./flash-common/utils","./fake-objects","./button","util"],function(S ,require, exports, module) {
/**
 * @ignore
 * xiami-music button
