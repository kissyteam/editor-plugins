...
*/
KISSY.add('editor-plugins/lib/xiami-music', [
    'editor',
                ...
                dataFilter.addRules({
                    tags: {
                        'object': function (element) {
                            var
                                //增加音乐名字提示
                                title = element.getAttribute('title'), i, c, classId = element.getAttribute('classid');
                            ...
                            for (i = 0; i < childNodes.length; i++) {
                                c = childNodes[i];    //innerHTML 会莫名首字母大写，还会加入一些属性
                                                      //Movie
                                //innerHTML 会莫名首字母大写，还会加入一些属性
                                //Movie
                                if (c.nodeName === 'param' && // ie 自动属性名大写
