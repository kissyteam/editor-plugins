...
*/
KISSY.add('editor-plugins/lib/resize', [
    'dd',
    'node',
    'util'
 ...
 */
    ...
    Resize.prototype = {
        pluginRenderUI: function (editor) {
            var Draggable = DD.Draggable, statusBarEl = editor.get('statusBarEl'), cfg = this.config, direction = cfg.direction || [
                    'x',
                    'y'
                ];
            ...
            var d = new Draggable({
                    node: resizer,
                    groups: false
                }), height = 0, width = 0, heightEl = editor.get('el'), widthEl = editor.get('el');
