define('kg/editor-plugins/1.1.10/xiami-music',["editor","./flash-common/base-class","./flash-common/utils","./fake-objects","./button","util"],function(require, exports, module) {
/**
 * @ignore
 * xiami-music button
