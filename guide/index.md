...
使用前先引入editor-plugins的模块依赖表，避免模块串行加载，优化性能。`http://g.tbcdn.cn/kg/editor-plugins/1.1.10/mods.js`

	require(['node','editor','kg/editor-plugins/1.1.10/font-size','kg/editor-plugins/1.1.10/source-area','kg/editor-plugins/1.1.10/image'], function(Node, Editor, FontSize, SourceArea, Image){
